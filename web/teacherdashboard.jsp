<%-- 
    ...
    Created on : Feb 2, 2018, 1:54:08 PM
    Author     : admin
--%>
...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>TeacherDashboard::CollagePerformanceEvaluationSystem</title>
...
@-webkit-keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}@keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}.chartjs-render-monitor{-webkit-animation:chartjs-render-animation 0.001s;animation:chartjs-render-animation 0.001s;}</style>
  <!--<link href="Dashboard Template for Bootstrap_files/grid.css" rel="stylesheet" type="text/css">-->
</head>
      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            ...
            <li class="nav-item">
                <a class="nav-link" href="marks123.jsp">
                ...
                <li class="nav-item">
                <a class="nav-link" href="classtestmarks.jsp">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bar-chart-2"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                  Classtest Marks
                </a>
              </li>
			...
			<!--	<li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link list-group-item" href="StudentDashboard.html">
  ...
  <div class="row">
    <div class="col-4">
      <div class="list-group" id="list-tab" role="tablist">
		  <a class="list-group-item list-group-item-action active show" id="list-mon-list" data-toggle="tab" href="#list-mon" role="tab" aria-controls="list-mon" aria-selected="true">Monday</a> 
		  <a class="list-group-item list-group-item-action" id="list-tues-list" data-toggle="tab" href="#list-tues" role="tab" aria-controls="list-tues" aria-selected="false">Tuesday</a> 
		  <a class="list-group-item list-group-item-action" id="list-wed-list" data-toggle="tab" href="#list-wed" role="tab" aria-controls="list-wed" aria-selected="false">Wednesday</a> 
		  <a class="list-group-item list-group-item-action" id="list-thur-list" data-toggle="tab" href="#list-thur" role="tab" aria-controls="list-thur" aria-selected="false">Thursday</a> 
		  <a class="list-group-item list-group-item-action" id="list-fri-list" data-toggle="tab" href="#list-fri" role="tab" aria-controls="list-fri" aria-selected="false">Friday</a>
		  <a class="list-group-item list-group-item-action" id="list-sat-list" data-toggle="tab" href="#list-sat" role="tab" aria-controls="list-sat" aria-selected="false">Saturday</a>
		  </div>
    </div>
    <div class="col-8">
      <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade active show" id="list-mon" role="tabpanel" aria-labelledby="list-mon-list">
          <p><h5><span class="badge badge-primary ">Mon</span></h5>
  ...
  <tbody>
    <tr>
      ...
      <th scope="row">10:30</th>
        ...
        <div class="tab-pane fade" id="list-tues" role="tabpanel" aria-labelledby="list-tues-list">
           <p><h5><span class="badge badge-primary ">Tues</span></h5>
		<div class="table-responsive">
  		<table class="table">
    		<thead>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <th scope="row">10:30</th>
        ...
        <div class="tab-pane fade" id="list-wed" role="tabpanel" aria-labelledby="list-wed-list">
           <p><h5><span class="badge badge-primary ">Wed</span></h5>
		<div class="table-responsive">
  		<table class="table">
    		<thead>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <th scope="row">10:30</th>
        ...
        <div class="tab-pane fade" id="list-thur" role="tabpanel" aria-labelledby="list-thur-list">
           <p><h5><span class="badge badge-primary ">Thur</span></h5>
		<div class="table-responsive">
  		<table class="table">
    		<thead>
    <tr>
    ...
    <tr>
      ...
      <th scope="row">10:30</th>
		...
		<td>Subject1</td>
		 ...
		 <div class="tab-pane fade" id="list-fri" role="tabpanel" aria-labelledby="list-fri-list">
           <p><h5><span class="badge badge-primary ">Fri</span></h5>
		<div class="table-responsive">
  		<table class="table">
    		<thead>
    <tr>
    ...
    <tr>
      ...
      <th scope="row">10:30</th>
		...
		<td>Subject1</td>
		 ...
		 <div class="tab-pane fade" id="list-sat" role="tabpanel" aria-labelledby="list-sat-list">
           <p><h5><span class="badge badge-primary ">Sat</span></h5>
		<div class="table-responsive">
  		<table class="table">
    		<thead>
    <tr>
    ...
    <table class="table table-bordered grid">
        <thead>
            <tr class="text-muted">
                ...
                <th>Thursday</th>
                <th>Friday</th>
                <th class="alert-info">Saturday</th>
            </tr>
        </thead>
        <tbody>
            <tr>
...
<form action="teacher_dash_process.jsp">
<button class="btn btn-primary form-control btn-warning" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Before marking Students' Attendance </button><br>
...
<%   
    int aCnt=0;
    teacher_dash_validate app=new teacher_dash_validate();
       ResultSet rs2= app.getCount();
      //System.out.println("cCnt=" +cCnt);
      // rs2.next();
       //aCnt = rs2.getInt(1);
       System.out.println("aCnt=" +aCnt);
        //candidateregis1 ch = new candidateregis1();
        //ResultSet rs1= ch.approve_candidate();
      //while (rs1.next())
      //{
          //cCnt++;
     // }
      ...
      //teacher_dash_validate cr=new teacher_dash_validate();
            ResultSet rs= app.getList();
            System.out.println("after get list");

           
  %>

<input type="hidden" name="cCnt" value="<%=aCnt %>" />  
 		
<div class="table-responsive">
            <table class="table table-striped table-sm" id="studAttend">
              <thead>
                <tr>
                  <th>Roll No</th>
	<th>
                 <div class="btn-group" role="group">
                                    <button id="" type="button" class="btn btn-group dropdown-toggle btn-group-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Attendance 
                                     </button>
                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        <!-- <a class="dropdown-item" id="checkAll" >Check All</a>-->
	  <div class="checkbox">
                        <label>
                            <input type="checkbox" class="check " id="checkAll" data-toggle="checkboxes" data-action="check"> Check All
                        </label>
                     </div>
                    </div>
             </div>
	...
	<th> <button type="submit" class="btn btn-primary btn-sm btn-outline-success"> Submit</button></th>
                </tr>
              </thead>
              <tbody>
                <%  while(rs.next())
      { %>
                <tr>
                  ...
                  <td><div class="checkbox"> <label><input type="checkbox" class="check" id="<%=rs.getString("roll_no")%>" name="<%=rs.getString("roll_no")%>" >Check me </label></div></td>
                  <td><%=rs.getString("stud")%></td>                    
                  </tr>
			...
			<hr class=""><div class="bd-example" role="tabpanel">
  <div class="row">
    <div class="col-4">
    ...
    <div class="col-8">
      <div class="tab-content" id="">
        <div class="tab-pane fade active show" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
          <p>
	  <h5><span class="badge badge-primary ">Present Month</span></h5>
	<div class="progress">
  <div class="progress-bar progress-bar-striped bg-info progress-bar-animated" role="progressbar" style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"><h5>40</h5></div>
	...
	<h5><span class="badge badge-primary ">Previous Month</span></h5>
	<div class="progress">
  <div class="progress-bar progress-bar-striped bg-info progress-bar-animated" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><h5>25</h5></div>
	...
	<!--<h5><span class="badge badge-primary ">Previous Month2</span></h5>
	<div class="progress">
  <div class="progress-bar progress-bar-striped bg-info progress-bar-animated" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"><h5>50</h5></div>
	...
	<h5><span class="badge badge-primary ">Previous Month3</span></h5>
<div class="progress">
  <div class="progress-bar progress-bar-striped bg-info progress-bar-animated" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><h5>75</h5></div>
	...
	<h5><span class="badge badge-primary ">Previous Month4</span></h5>
<div class="progress">
...
<div class="progress">
  ...
  <div class="progress-bar bg-info progress-bar-animated" role="progressbar" style="width: 40%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">Attendance</div>
	...
	<script type="text/javascript" src="./bootstraps/Dashboard Template for Bootstrap_files/app.js"></script>
	<script type="text/javascript" src="./bootstraps/Dashboard Template for Bootstrap_files/jquery.checkboxes-1.2.0.js"></script>
	<script type="text/javascript" src="./bootstraps/Dashboard Template for Bootstrap_files/jquery.checkboxes-1.2.0.min.js"></script>
    <!-- Icons -->
