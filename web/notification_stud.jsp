<%-- 
    Document   : notification_stud
    Created on : Mar 17, 2018, 9:43:33 AM
    Author     : admin
--%>
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="studentdashboard.jsp">Student Dashboard <span class="sr-only">(current)</span></a>
          </li>
        <!-- <li class="nav-item">
  ...
  <span class="sr-only">unread messages</span>
   ...
   <!-- <div class="nav-scroller bg-white box-shadow">
    ...
    <main role="main" class="container">
     ...
     <%   
    int aCnt=0;
   Notification_stud_validate app=new Notification_stud_validate();
  ...
  <input type="hidden" name="cCnt" value="<%=aCnt %>" />  
      ...
      { %>
        ...
        <div class="media text-muted pt-3">
          <!--<img data-src="holder.js/32x32?theme=thumb&amp;bg=007bff&amp;fg=007bff&amp;size=1" alt="32x32" class="mr-2 rounded" style="width: 32px; height: 32px;" src="data:image/svg+xml;charset=UTF-8,%3Csvg%20width%3D%2232%22%20height%3D%2232%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2032%2032%22%20preserveAspectRatio%3D%22none%22%3E%3Cdefs%3E%3Cstyle%20type%3D%22text%2Fcss%22%3E%23holder_161b21f1e04%20text%20%7B%20fill%3A%23007bff%3Bfont-weight%3Abold%3Bfont-family%3AArial%2C%20Helvetica%2C%20Open%20Sans%2C%20sans-serif%2C%20monospace%3Bfont-size%3A2pt%20%7D%20%3C%2Fstyle%3E%3C%2Fdefs%3E%3Cg%20id%3D%22holder_161b21f1e04%22%3E%3Crect%20width%3D%2232%22%20height%3D%2232%22%20fill%3D%22%23007bff%22%3E%3C%2Frect%3E%3Cg%3E%3Ctext%20x%3D%2211.546875%22%20y%3D%2216.9%22%3E32x32%3C%2Ftext%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E" data-holder-rendered="true"> -->
          <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <textarea class="form-control" id="Textarea" rows="3" readonly>@ <%=rs1.getString("name")%> .  <%=rs1.getString("msg")%></textarea>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <div class="modal-dialog" role="document">
    ...
    <script>var text=$("textarea").val(); alert(text);</script>
...
<text x="0" y="2" style="font-weight:bold;font-size:2pt;font-family:Arial, Helvetica, Open Sans, sans-serif">32x32</text></svg></body></html>
