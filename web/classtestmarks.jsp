<%-- 
    Document   : classtestmarks
    Created on : Apr 22, 2018, 7:22:38 PM
    Author     : admin
--%>
...
<%   
    int aCnt=0;
   classtest_validate app=new classtest_validate();
...
<form action="classtestmarks_process.jsp">
<div class="collapse" id="collapseClasstest">
      ...
      { %>
       ...
       <tr>
                  ...
                  <td><%=rs.getString("stud")%></td>
                      <td><select class="custom-select d-block w-100" id="opt_1<%=rs.getString("roll_no")%>" name="opt1_<%=rs.getString("roll_no")%>" required="">
	  ...
	  <option>5</option>
                ...
                <div class="invalid-feedback">
                  Please select a valid option.
                    ...
                    <td><select class="custom-select d-block w-100" id="opt_2<%=rs.getString("roll_no")%>" name="opt2_<%=rs.getString("roll_no")%>" required="">
                  <option value="">Out Of 5</option>
                  <option>0</option>
                  <option>1</option>
	 <option>2</option>
