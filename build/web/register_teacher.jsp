...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>RegTeacher::CollagePerformanceEvaluationSystem</title>
    ...
    <div class="container">
      <div class="py-5 text-center">
       <!-- <img class="d-block mx-auto mb-4" src="./Checkout example for Bootstrap_files/bootstrap-solid.svg" alt="" width="72" height="72"> -->
        ...
        <p class="lead">Teacher registeration portal. Please make sure Lecture details are filled and inserted first before Submission.</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12 order-md-12">
          ...
          <form class="needs-validation" novalidate="" action="register_teacher_process.jsp">
            <div class="row">
              <div class="col-md-6 mb-3">
                <label for="firstName">Qulifications</label>
                <input type="text" class="form-control" name="qualifications" placeholder="" value="" required="">
                <div class="invalid-feedback"> Valid qualification required. </div>
              </div>
              <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" name="exp" placeholder="" value="" required="">
...
-->
    ...
    <div class="row clearfix">
		<div class="col-md-12 column">
			<table class="table table-bordered table-responsive grid" id="tab_logic">
				<thead>
					<tr >
						<th class="text-center">
							No.
						</th>
						<th class="text-center card-columns">
							Year
						</th>
						<th class="text-center col-1 card-columns">
							Class
						</th>
						<th class="text-center card-columns">
							Subject
							<small class="text-muted">(UniCode)</small>
						</th>
						<th class="text-center card-columns">
							Subject Name
						</th>
            ...
            <select class="custom-select d-block w-100 " >
                  <option value="">Choose...</option>
                  <option>FY Sem1</option>
					<option>FY Sem2</option>
				 	<option>SY Sem3</option>
					<option>SY Sem4</option>
					<option>TY Sem5</option>
					<option>TY Sem6</option>
                </select>
                <div class="invalid-feedback">
              ...
              <select class="custom-select d-block w-100" >
				...
				<div class="invalid-feedback">Please select a valid Day.</div>
						...
						<td>
						 <div class="input-group">
              <input type="text" class="form-control" placeholder="Uni Code">
                         </div>
						</td>
						<td>
						 <div class="input-group">
               ...
               <select class="custom-select d-block w-100" >
                ...
                <div class="invalid-feedback">
                  Please select a valid Day.
						...
						<td class="col-12">
						 <div class="input-group">
							 <div class="row"><input type="time" class="form-control" ></div>
               <div class="row"><input type="time" class="form-control" ></div>
                         </div>
						</td>
					</tr>
