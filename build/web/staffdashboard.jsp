<%-- 
    ...
    Created on : Feb 2, 2018, 1:52:32 PM
    Author     : admin
--%>
...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>StaffDashboard::CollagePerformanceEvaluationSystem</title>
...
<h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
 ...
 <form action="staff_dash_process.jsp">
 <div class="btn-group dropright">
  ...
  <div class="dropdown-menu form-control">
      <input type="date" class="form-control-file" name="att_date" >
    <!-- Dropdown menu links -->
  </div>
</div>
 ...
 <div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1">@</span>
     ...
     %>
     <input type="text" class="form-control list-group-item disabled" placeholder=<%=userid%> value="" aria-label="Username" aria-describedby="basic-addon1" disabled>
</div>
</div>
         ...
         <!--<h2>Welcome</h2>-->
         <p> <a class="btn btn-light form-control" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Mark Your Attendance here </a></p>
         <div class="row">
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample1">
      <div class="card card-body">
        <div class="input-group mb-3">
  <div class="input-group-prepend">
    <button class="btn btn-outline-secondary form-control" type="button" data-toggle="modal" data-target=".bd-example-modal-sm">Present<small>(Click Me)</small></button>
	  
<div class="modal fade bd-example-modal-sm " tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm form-control">
    <div class="modal-content form-control">
     ...
     <input type="text" class="form-control" placeholder="<%=userid%>" aria-label="" aria-describedby="basic-addon1"  readonly>
</div>
      </div>
    </div>
  </div>
...
<div class="bd-example" role="tabpanel">
  <div class="row">
    <div class="col-4">
      <div class="list-group" id="list-tab" role="tablist">
		  <a class="list-group-item list-group-item-action active show" name="mon" data-toggle="tab" href="#list-mon" role="tab" aria-controls="list-mon" aria-selected="true">Monday</a> 
		  <a class="list-group-item list-group-item-action" name="tues" data-toggle="tab" href="#list-mon" role="tab" aria-controls="list-tues" aria-selected="false">Tuesday</a> 
		  <a class="list-group-item list-group-item-action" name="wed" data-toggle="tab" href="#list-wed" role="tab" aria-controls="list-wed" aria-selected="false">Wednesday</a> 
		  <a class="list-group-item list-group-item-action" name="thurs" data-toggle="tab" href="#list-thur" role="tab" aria-controls="list-thur" aria-selected="false">Thursday</a> 
		  <a class="list-group-item list-group-item-action" name="fri" data-toggle="tab" href="#list-fri" role="tab" aria-controls="list-fri" aria-selected="false">Friday</a>
		  <a class="list-group-item list-group-item-action" name="sat" data-toggle="tab" href="#list-sat" role="tab" aria-controls="list-sat" aria-selected="false" >Saturday</a>
		  </div>
    </div>
    <div class="col-8">
  ...
  <tbody>
    <tr>
  <form method="GET" action="staff_dash_process.jsp">
      <input type="text" name="week" value="mon" hidden/>
      <input type="submit" >
  </form>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    ...
    <span style="border-radius: 3px; text-indent: 20px; width: auto; padding: 0px 4px 0px 0px; text-align: center; font-style: normal; font-variant: normal; 
          font-weight: bold; font-stretch: normal; font-size: 11px; line-height: 20px; font-family: & quot;Helvetica Neue&quot;, Helvetica, sans-serif; color: rgb(255, 255, 255); 
