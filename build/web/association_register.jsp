<%-- 
    Document   : association_register
    Created on : Feb 27, 2018, 2:17:14 PM
    Author     : admin
--%>
...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>AssociationRegistration::CollagePerformanceEvaluationSystem</title>
  ...
  <body class="bg-light">
    ...
    <div class="container">
      ...
      <div class="row">
       <!-- <div class="col-md-4 order-md-2 mb-4">
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Association Details</h4>
          <form class="needs-validation" novalidate="" action="association_register_process.jsp">
            <div class="row">
                 <!--<select class="custom-select d-block w-100" required="" name="asso_name">
                  <option value="">Choose...</option>
                  <option>IT Association</option>
                  <option>IB Association</option>
                  <option>Investers Association</option>
                  <option>English Association</option>
                  <option>Quiz Club Association</option>
                  <option>Book Lovers Association</option>
                </select>
                <div class="invalid-feedback">
                  Please select a valid association name.
                </div>-->
              <div class="col-md-6 mb-3">
                <label for="Name">Name</label>
                <input type="text" class="form-control" name="asso_name" placeholder="eg. IT Association" value="" required="">
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
              <label for="username">Teacher In-Charge</label>
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">@</span>
                </div>
                <input type="text" class="form-control" name="teacher-incharge" placeholder="Username" required="">
           ...
           <!-- <div class="mb-3">
              <label for="email">Venue <!--<span class="text-muted">(Optional)</span></label>
      ...
      <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">© 2017-2018 NESS WADIA COLLEGE OF COMMERCE</p>
