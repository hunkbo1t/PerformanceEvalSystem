...
public class register_teacher_validate {
...
public static boolean validate(String qualifications,int sal,String exp){
...
String sql = "insert into teacher_registration values('"+qualifications+"',"+sal+",'"+exp+"') ";
