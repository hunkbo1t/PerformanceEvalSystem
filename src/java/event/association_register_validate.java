 ...
 * @author tmondal
 */
public class association_register_validate {
...
public static boolean validate(String asso_name,String incharge){
Connection conn = null;
Statement stmt = null;
boolean status=false;
System.out.println("I am in asso registration validate");
...
String sql = "insert into asso_registration values('"+asso_name+"','"+incharge+"') ";


//ps.setString(1,bean.getUserID());
//ps.setString(2, bean.getPassword());
//log.info("SQL=" + sql);
System.out.println("asso register Validate sql="+sql);
